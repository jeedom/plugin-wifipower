...
?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <?php echo network::getNetworkAccess('internal') ?>/plugins/wifipower/core/php/jeeWifipower.php?apikey=<?php echo jeedom::getApiKey($plugin->getId()); ?>
            </div>
        </div>
    </fieldset>
</form>
